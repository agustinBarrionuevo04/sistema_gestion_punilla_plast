...
export default function FacturaForm({ onNavigate }) {
  const { state, addFactura, addMovimiento, getProductById } = useStore();
  ...
  const handleGuardar = () => {
    ...
    addMovimiento({
      ...
      monto: total,
      fecha,
      descripcion: `Factura ${facturaNum}`,
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold text-text-primary mb-6">Nueva Factura Directa</h2>

      <div className="bg-warning-light border border-warning rounded-xl p-3 mb-6 flex items-start gap-2">
        <AlertTriangle size={18} className="text-warning shrink-0 mt-0.5" />
        <p className="text-sm text-amber-800">
          Comprobante simple no fiscal. La facturación electrónica con ARCA estará disponible
          próximamente.
        </p>
      </div>
